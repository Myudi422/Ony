...
var BuildId = "R9iTdT4DVkpHKdpiCzjFJ";
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/dashboard/:path*" }, { "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/admin(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/admin/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "R9iTdT4DVkpHKdpiCzjFJ", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "FCzmtXiDkbnpeb5GOcqFTB3peVicsu5gqTWV26hMyMw=", "__NEXT_PREVIEW_MODE_ID": "f5c8dded5d669c4c6b3b7b6531bd2c2b", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "a1988c185aaee60c4d348778ac99b8bd9bf7247c6e8e573617f16d9c7d7826fd", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "499a8324725635855392e89c6a68de5c88c7c64bd97304f74381bb5025093eb8" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/auth/[...nextauth]/route": "/api/auth/[...nextauth]", "/api/tap-log/route": "/api/tap-log", "/api/webhooks/cashi/route": "/api/webhooks/cashi", "/api/webhooks/midtrans/route": "/api/webhooks/midtrans", "/api/admin/audit/route": "/api/admin/audit", "/api/admin/backup/cron/route": "/api/admin/backup/cron", "/api/admin/backup/schema/route": "/api/admin/backup/schema", "/api/admin/backup/route": "/api/admin/backup", "/api/admin/pricing/route": "/api/admin/pricing", "/api/admin/orders/route": "/api/admin/orders", "/api/admin/users/[id]/cards/route": "/api/admin/users/[id]/cards", "/api/admin/settings/route": "/api/admin/settings", "/api/analytics/route": "/api/analytics", "/api/admin/users/route": "/api/admin/users", "/api/cards/[id]/route": "/api/cards/[id]", "/api/cards/[id]/check-payment/route": "/api/cards/[id]/check-payment", "/api/cards/[id]/pay/route": "/api/cards/[id]/pay", "/api/cards/mine/route": "/api/cards/mine", "/api/cards/claim/route": "/api/cards/claim", "/api/click/route": "/api/click", "/api/cards/transfer/route": "/api/cards/transfer", "/api/cards/seller-claim/route": "/api/cards/seller-claim", "/api/admin/media/route": "/api/admin/media", "/api/profile/route": "/api/profile", "/api/tap/[code]/route": "/api/tap/[code]", "/api/orders/route": "/api/orders", "/api/tools/google-review-generator/route": "/api/tools/google-review-generator", "/api/links/route": "/api/links", "/page": "/", "/login/page": "/login", "/c/[code]/page": "/c/[code]", "/admin/orders/page": "/admin/orders", "/admin/audit/page": "/admin/audit", "/admin/media/page": "/admin/media", "/admin/qr-generator/page": "/admin/qr-generator", "/admin/pricing/page": "/admin/pricing", "/admin/page": "/admin", "/admin/users/page": "/admin/users", "/dashboard/cards/page": "/dashboard/cards", "/admin/settings/page": "/admin/settings", "/dashboard/page": "/dashboard", "/dashboard/analytics/page": "/dashboard/analytics", "/dashboard/settings/page": "/dashboard/settings", "/dashboard/store/page": "/dashboard/store", "/google-review/page": "/google-review" };
